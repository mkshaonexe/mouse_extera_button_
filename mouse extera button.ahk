...
; Mouse Button Remaps
; ------------------------------------------------------------
XButton2::CreateMenuGui()   ; Forward button opens radial launcher
MButton::Send("#+s")        ; Middle button → Snip & Sketch (Win+Shift+S)
...
items := [
    ...
    {name: "AI", target: "C:\Users\MK Shaon\AppData\Local\Programs\cursor\Cursor.exe"},
    {name: "ChatGPT", target: "https://chat.openai.com"},
    {name: "Notepad", target: "notepad.exe"},
    {name: "Android Studio", target: "E:\Android Studio\bin\studio64.exe"},
